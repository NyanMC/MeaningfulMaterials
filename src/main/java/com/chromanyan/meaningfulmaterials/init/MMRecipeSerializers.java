...
public class MMRecipeSerializers {
    ...
    public static final RegistryObject<RecipeSerializer<EnhanceFoodRecipe>> ENHANCE_FOOD = RECIPE_SERIALIZERS_REGISTRY.register("enhance_food", () -> new SimpleRecipeSerializer<>(EnhanceFoodRecipe::new));
}
