...
public class InfernalFireBlock extends BaseFireBlock {
    ...
    public InfernalFireBlock() {
        super(Properties.of().mapColor(MapColor.FIRE).replaceable().noCollission().instabreak()
                .lightLevel(value -> 15).sound(SoundType.WOOL).pushReaction(PushReaction.DESTROY), 1f);
    }
